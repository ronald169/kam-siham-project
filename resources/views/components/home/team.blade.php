                ...
                <div class="relative overflow-hidden rounded-lg">
                   ...
                   <div class="absolute bottom-5 left-0 w-full text-center">
                      <div
                         ...
                         <p class="text-body-color dark:text-dark-6 text-xs">Dr.</p>
                         <div>
                ...
                <div class="relative overflow-hidden rounded-lg">
                   ...
                   <div class="absolute bottom-5 left-0 w-full text-center">
                      <div
                         ...
                         <p class="text-body-color dark:text-dark-6 text-xs">AS.</p>
                         <div>
                            <span class="absolute left-0 bottom-0">
                               <svg
                                  width="61"
                ...
                <div class="relative overflow-hidden rounded-lg">
                   ...
                   <div class="absolute bottom-5 left-0 w-full text-center">
                      <div
                         ...
                         <p class="text-body-color dark:text-dark-6 text-xs">Medecin</p>
                         <div>
                            <span class="absolute left-0 bottom-0">
                               <svg
                                  width="61"
                ...
                <div class="relative overflow-hidden rounded-lg">
                   ...
                   <div class="absolute bottom-5 left-0 w-full text-center">
                      <div
                         ...
                         <p class="text-body-color dark:text-dark-6 text-xs">Infirmier</p>
                         <div>
                            <span class="absolute left-0 bottom-0">
                               <svg
                                  width="61"
